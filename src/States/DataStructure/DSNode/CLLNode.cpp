...
CLLNode::CLLNode(float x, float y, float scale_x, float scale_y, int _val, sf::Font *_font, std::map<std::string, sf::Color> *Colors)
{
    this->Colors = Colors;
    ...
    arrow.setSize(sf::Vector2f(100.f, 30.f));
...
//Next
void CLLNode::updateNext()
{
    this->next = array_next[idx_next];
}

void CLLNode::newNext(CLLNode *new_next)
{
...
void CLLNode::prevNext()
{
    this->idx_next--;
    this->updateNext();
}

void CLLNode::nextNext()
{
    this->idx_next++;
    this->updateNext();
}
...
//Val
void CLLNode::updateVal()
{
    this->val = array_val[idx_val];
}

void CLLNode::newVal(int new_val)
{
...
void CLLNode::prevVal()
{   
    this->idx_val--;
    this->updateVal();
}

void CLLNode::nextVal()
{
    this->idx_val++;
    this->updateVal();
}
...
void CLLNode::newLabel(std::string new_label)
{
...
void CLLNode::prevLabel()
{
    this->idx_label--;
    this->updateLabel();
}

void CLLNode::nextLabel()
{
    this->idx_label++;
    this->updateLabel();
}
...
void CLLNode::newPos(sf::Vector2f new_pos)
{
...
void CLLNode::prevPos()
{
    this->idx_pos--;
    this->updatePos();
}

void CLLNode::nextPos()
{
    this->idx_pos++;
    this->updatePos();
}
...
//Render
void CLLNode::renderAnimation()
{
}

void CLLNode::render(sf::RenderTarget *target)
{
    this->updateText();
    this->updateLabel();
